<?php
    ...
    if(isset($_SERVER['REQUEST_METHOD']) && $_SERVER['REQUEST_METHOD'] == "POST"){
        ...
        if($input_array == 39158){
            $result = mysqli_query($connection, "SELECT ST_AsText(coordenadas) as poligono, ST_AsText(ST_Centroid(coordenadas)) as centroide, descricao, foto, nome, limite_ambulantes, quantidade_ambulantes, id FROM zonas");    
