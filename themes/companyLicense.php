            ...
            <fieldset>
                <div class="row mb-5">
                    ...
                    <div class="col-xl-3">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-input" id="cnpj" name="cnpj"
                                   placeholder="Ex.: 00.000.000/0000-00"" required>
                        </div>
                    </div>
                    ...
                    <div class="col-xl-3">
                        <div class="form-group">
                            <label>CMC:</label>
                            <input type="text" class="form-input" id="cmc" name="cmc" placeholder="Ex.: 0000000000"
                                   required>
                        </div>
                    </div>
                    ...
                    <div class="col-xl-3">
                        <div class="form-group">
                            <label>RG:</label>
                            <input type="text" class="form-input" id="rg" name="rg" placeholder="Ex.: 0000000-0"
                                   required>
                        </div>
                    </div>
                    ...
                    <div class="col-xl-4">
                        <div class="form-group">
                            <label>Nome do cadastrante:</label>
                    ...
                    <div class="col-xl-6">
                        <div class="form-group">
                            ...
                            <input type="email" class="form-input" id="email" name="email"
                                   placeholder="Ex.: exemplo@email.com" required>
                        </div>
                    </div>
                    ...
                    <div class="col-xl-6">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-input" id="phone" name="phone"
                                   placeholder="Ex.: 0000-0000" required>
                        </div>
                    </div>
                    ...
                    <div class="col-xl-12">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-input" id="street" name="street"
                                   placeholder="Ex.: Avenida Fernandes Lima" required>
                        </div>
                    </div>
                    ...
                    <div class="col-xl-3">
                        <div class="form-group">
                            <label>Número:</label>
                            <input type="text" class="form-input" id="number" name="number" placeholder="Ex.: 35"
                                   required>
                        </div>
                    </div>
                    ...
                    <div class="col-xl-3">
                        <div class="form-group">
                            <label>Cidade:</label>
                            <input type="text" class="form-input" id="city" name="city" placeholder="Ex.: Maceió"
                                   required>
                        </div>
                    </div>
                    ...
                    <div class="col-xl-3">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-input" id="postcode" name="postcode"
                                   placeholder="Ex.: 57000000" required>
                        </div>
                    </div>
                    ...
                    <div class="col-xl-4">
                        <div class="form-group">
                            ...
                            <input type="number" class="form-input" id="equipamentAmount" name="equipamentAmount"
                    ...
                    <div class="col-xl-6">
                        <div class="row">
                            ...
                            <div class="col-xl-6 text-left">
                                <label class="label-file companyLogo-file text-center" for="companyLogo"><span
                                        class="icon-plus mr-2"></span> Selecionar Arquivo</label>
                                <input class="hidden-input-file" type="file" onchange="uploadImage(this)"
                                       id="companyLogo" name="userImage" accept="image/png, image/jpg, image/jpeg">
                    ...
                    <div class="col-xl-6">
                        <div class="row">
                            ...
                            <div class="col-xl-6 text-left">
                                <label class="label-file cnpjRegistration-file text-center" for="cnpjRegistration"><span
                                        class="icon-plus mr-2"></span> Selecionar Arquivo</label>
                                <input class="hidden-input-file" type="file" onchange="uploadImage(this)"
                                       id="cnpjRegistration" name="cnpjRegistration" accept="image/png, image/jpg, image/jpeg">
                                <div class="invalid-feedback"></div>
                    ...
                    <div class="col-xl-6">
                        <div class="row">
                            ...
                            <div class="col-xl-6 text-left">
                                <label class="label-file socialContract-file text-center" for="socialContract"><span
                                        class="icon-plus mr-2"></span> Selecionar Arquivo</label>
                                <input class="hidden-input-file" type="file" onchange="uploadImage(this)"
                                       id="socialContract" name="socialContract" accept="image/png, image/jpg, image/jpeg">
                                <div class="invalid-feedback"></div>
                    ...
                    <div class="col-xl-6">
                        <div class="row">
                            <div class="col-xl-6">
                                <div class="form-group">
                                    <label>Alvará de funcionamento/sanitário:</label>
                                </div>
                            </div>

                            <div class="col-xl-6 text-left">
                                <label class="label-file businessLicense-file text-center" for="businessLicense"><span
                                        class="icon-plus mr-2"></span> Selecionar Arquivo</label>
                                <input class="hidden-input-file" type="file" onchange="uploadImage(this)"
                                       id="businessLicense" name="businessLicense" accept="image/png, image/jpg, image/jpeg">
                                <div class="invalid-feedback"></div>
                    ...
                    <div class="col-xl-6">
                        <div class="row">
                            ...
                            <div class="col-xl-6 text-left">
                                <label class="label-file otherDocument-file text-center" for="otherDocument"><span
                                        class="icon-plus mr-2"></span> Selecionar Arquivo</label>
                                <input class="hidden-input-file" type="file" onchange="uploadImage(this)"
                                       id="otherDocument" name="otherDocument" accept="image/png, image/jpg, image/jpeg">
                                <div class="invalid-feedback"></div>
